...
생성 규칙:
- 평가 설명: 성취기준을 학생이 수행할 구체적인 과제로 변환한 문제 안내문. 끝에 총점 표시. 200자 이내.
- 평가 조건: 채점기준의 각 항목을 학생 행동 지시문으로 변환. 반드시 마크다운 형식으로 작성. 350자 이내.
  - 항목명은 순서가 있는 번호 목록(1. 2. 3.)으로 작성
  - 각 항목의 세부 지시사항은 불렛(- )으로 작성
  - 예시:
    1. 항목명 (배점 N점)
    - 구체적인 작성 안내
    - 구체적인 작성 안내
